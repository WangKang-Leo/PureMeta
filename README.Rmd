...
Step1: Extracting tumor cell GEP from bulk RNA-seq/microarray data, where you also need tumor adjacent tissue GEP as control. The bulk tumor and normal GEP come from the sample experiments (no significant batch effect existed). Make sure GEP data is in normal (not log) space. This example used 30 tumor and 5 non-cancerous breast tissue (normal) GEP from [GSE87455](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE87455).

```{r Step1, echo = FALSE,warning=FALSE,message=FALSE}
library(PureMeta)
...
For bulk GEP 
```{r Step2 bulk GEP, echo = FALSE,warning=FALSE,message=FALSE}
...
For Tumor cell GEP 
```{r Step2 TC GEP,echo = FALSE,warning=FALSE,message=FALSE}
